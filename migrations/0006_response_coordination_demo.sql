...
INSERT OR REPLACE INTO response_partners VALUES
  ('partner-high-country', 'High Country Community Response', 'local',
   ...
   'operations@highcountry.example', 1, 'Watauga Relief Corridor', '2030-09-28T13:24:00.000Z'),
  ('partner-blue-ridge-water', 'Blue Ridge Water Network', 'regional',
   ...
   'dispatch@blueridgewater.example', 0, 'Watauga Relief Corridor', '2030-09-28T13:18:00.000Z'),
  ('partner-mountain-shelter', 'Mountain Shelter Alliance', 'local',
   ...
   'coordination@mountainshelter.example', 1, 'Watauga Relief Corridor', '2030-09-28T13:09:00.000Z'),
  ('partner-appalachian-medical', 'Appalachian Mobile Health Team', 'regional',
   ...
   'fielddesk@apphealth.example', 0, 'Watauga Relief Corridor', '2030-09-28T12:55:00.000Z');
